...
export function CustomVideoPlayer({ videoUrl, posterUrl }) {
  ...
  return (
    <div className="relative">
      <div
        ...
        className={`relative w-full overflow-hidden rounded-xl border border-gray-300 dark:border-gray-700 aspect-[16/9] ${showControls ? "" : "cursor-none"
          }`}
      >
        <video
          ref={videoRef}
